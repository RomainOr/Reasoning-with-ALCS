...
class BACSClassifiersList(BaseClassifiersList):
    ...
    def form_match_set(
        ...
        """
        Builds the BACSClassifiersList from the whole population with all classifiers whose condition
        ...
        return BACSClassifiersList(*matching), best_fitness
    ...
    def form_action_set(
        ...
        return BACSClassifiersList(*matching)
